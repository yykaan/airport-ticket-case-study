...
import com.kaan.airportt.repository.FlightRepository;
...
public class FlightServiceImpl implements FlightService {
    ...
    @Override
    public List<Flight> findByFlightRoute(FlightRoute flightRoute) {
        return repository.findByFlightRoute(flightRoute);
    }
}
